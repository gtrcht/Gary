...
let round_duration = 180;
let no_of_categories_per_round = 12;
...
class Timer {
  ...
  reset() {
	...
	console.log(typeof this.secs);
	console.log(this.secs.toString());
    this.publish();
...
function setNewTimer() {
  round_duration = parseInt(document.getElementById("set_time").value);
  console.log("New timer set to: " + round_duration.toString() + " seconds.");
  game.timer.secs = round_duration;
  game.timer.reset();
  // game.timer.toggle();
}

function setNumCat() {
  no_of_categories_per_round = parseInt(document.getElementById("set_numcat").value);
  console.log("Number of categories set to: " + no_of_categories_per_round.toString() + ".");
  startNewRound();
}
